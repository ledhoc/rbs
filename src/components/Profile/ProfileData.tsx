  ...
  ceo: {
    ...
    timelines: [
      [
        ...
        {
          id: 2,
          company: "Projects in Fintech, AI",
          position: "Build team Senior Consultant",
          fromTo: "Sep 2023 ~ July 2024",
        },
      ],
      [
        {
      ...
      [
        {
          ...
          position: "Hiring, Build teams and Soft skills training ",
          fromTo: "May 2015 ~ Oct 2018",
        },
        {
          id: 2,
          company: "Project was invested from Swiss and Singaporean investors",
          position: "Content Management Systems (CMS) and File Management",
  ...
  coo: {
    ...
    about: (
      <p>
        ...
        <br />
        {`Also since 2010, I had opportunities to work with foreign investors who
        invested projects in Vietnam in many fields as education, human
        resource, co-working space, architectural design, Clubs, restaurants,
        hotels, tourism services, Information technology Has abundant human
        resource with good skills, competitive pricing and good landscape,
        Vietnam is an interesting choice to build and develop technical
        companies.`}
        <br />
        {` I expect to be able to consult IT projects to building strong teams,
